...
public class BluetoothDevicesListView {
    ...
    public BluetoothDevicesListView(BluetoothAdapter mBluetoothAdapter, BluetoothComm bluetoothMessageController) {
        this.mBluetoothAdapter = mBluetoothAdapter;
        this.mBluetoothMessageController = bluetoothMessageController;
    ...
    private void connectToDevice(String deviceAddress) {
        ...
        mBluetoothMessageController.connect(mBluetoothDevice);
    }
    ...
    public BluetoothComm getChatController() {
        return mBluetoothMessageController;
    }
