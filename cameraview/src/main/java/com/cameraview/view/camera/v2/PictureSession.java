package com.cameraview.view.camera.v2;
...
import com.cameraview.view.camera.Exif;
...
import static com.cameraview.view.camera.ICameraModule.DEBUG;
import static com.cameraview.view.camera.ICameraModule.TAG;
        ...
        private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
            ...
            public void onImageAvailable(final ImageReader reader) {
                mCameraView.getHandler().post(() -> {
                    Log.d(TAG, "OnImageAvailable file to write to " + mFile.getName());
                    try {
                        if (mFile != null) {
